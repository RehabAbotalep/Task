            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="governate" class="col-md-4 col-form-label text-md-right">{{ __('Governate') }}</label>

                            <div class="col-md-6">
                                <select class="form-control" id="governate" name="governate">
                        ...
                        <div class="form-group row">
                            <label for="channel_to_promote_in" class="col-md-4 col-form-label text-md-right">{{ __('Channels To Promote In') }}</label>

                            <div class="col-md-6">
                                <select class="form-control" id="channel_to_promote_in" name="channel_to_promote_in">
                                      <option value="facebook">Facebook</option>
                                      <option value="twitter">Twitter</option> 
                                      <option value="instgram">Instgram</option>     
                                </select>

                                @error('channel_to_promote_in')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
